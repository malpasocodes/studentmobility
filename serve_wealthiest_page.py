...
def show():
    ...
    st.write("We use several metrics to identify colleges that serve the wealthiest students. "
             "The metrics include the percentage of students from the top 1% and top 20% income brackets, and median parent income. " 
             "It turns out that colleges serve the wealthiest also tend to be the stingiest in accepting admissions from the "
    ...
    st.markdown("<h2 style='font-size:24px;color:brown'>Figure 1:  Colleges with Highest Enrollment from Top 1% Income</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='font-size:24px;color:brown'>Figure 2:  Colleges with Highest Enrollment from Top 20% Income</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='font-size:24px;color:brown'>Figure 3:  Enrollment from Bottom 20% vs Top 20% Income</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='font-size:24px;color:brown'>Table 1: Colleges with Highest Enrollment from Top 1% Income</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='font-size:24px;color:brown'>Table 2: Colleges with Highest Enrollment from Top 20% Income</h2>", unsafe_allow_html=True)
