...
def show():
    ...
    st.markdown("""
        Welcome to the student mobility dashboard. This dashboard allows you to explore data on economic mobility at different types of colleges. 
        The dashboard is work in progress. Please go to the About page on the navigation bar for more information.
    ...
    st.markdown("<h2 style='font-size:24px;color:blue'>Navigation</h2>", unsafe_allow_html=True)
    ...
    st.markdown("""
        ...
        - **2-Year Colleges (Top Performers):** Top 2-year colleges based on mobility rates.
        - **4-Year Colleges (Top Performers)**: Top 4-year colleges based on mobility rates.
        ...
        - **Statistics by Tier**: More arcane statistics for the cognoscenti. Coming soon.
    """)

    st.markdown("<h2 style='font-size:24px;color:blue'>Overview</h2>", unsafe_allow_html=True)
    ...
    st.write("2. **Income Quintiles**: What are Q1, Q2, Q3, Q4, and Q5? Income quintiles, as used by economists, divide a population into five equal parts based on household income."
    ...
    st.write("3. **Student Mobility**: Our basic unit of analysis will be economic quintiles and our focus is generational mobility."
    ...
    st.write("4. **Dataset**: The dataset used in this dashboard looks at students who entered a specific college in the years 1980, 1981, and 1982. Their starting income quintile is based on their parents' income. "
                ...
                "Q1 to Q2 means the probability that a student who comes from the bottom 20% of the income distribution (Q1) can move up to the second quintile (Q2). "
                ...
                "We also calculate a composite mobility score for each college based on the probability of moving up the entire income ladder from Q1 to Q5.")